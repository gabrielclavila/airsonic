...
public class PersonalSettingsCommand_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.airsonic.player.command.PersonalSettingsCommand"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PersonalSettingsCommand_ESTest_scaffolding.class.getClassLoader() ,
      "org.airsonic.player.command.PersonalSettingsCommand",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PersonalSettingsCommand_ESTest_scaffolding.class.getClassLoader()); 
