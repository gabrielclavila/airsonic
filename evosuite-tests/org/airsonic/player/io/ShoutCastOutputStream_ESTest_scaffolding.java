...
public class ShoutCastOutputStream_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.airsonic.player.io.ShoutCastOutputStream"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ShoutCastOutputStream_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.airsonic.player.io.ShoutCastOutputStream",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ShoutCastOutputStream_ESTest_scaffolding.class.getClassLoader()); 
