...
public class SearchCommand_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.airsonic.player.command.SearchCommand"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SearchCommand_ESTest_scaffolding.class.getClassLoader() ,
      "org.airsonic.player.domain.MediaFile",
      "org.airsonic.player.command.SearchCommand$Match",
      "org.airsonic.player.command.SearchCommand",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SearchCommand_ESTest_scaffolding.class.getClassLoader()); 
