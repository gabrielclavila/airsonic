...
public class PlayerSettingsCommand_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.airsonic.player.command.PlayerSettingsCommand"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PlayerSettingsCommand_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.airsonic.player.util.StringUtil",
      "org.airsonic.player.command.PlayerSettingsCommand",
      "org.airsonic.player.command.PlayerSettingsCommand$TranscodingHolder",
      ...
      "org.airsonic.player.command.EnumHolder",
      "org.airsonic.player.domain.InternetRadio"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PlayerSettingsCommand_ESTest_scaffolding.class.getClassLoader()); 
